...
void  Catcharp()
{
    ...
    while(1)
    {
        ...
        if(strstr((char *)rcvBuffer.padding, "zenreq") || strstr((char *)rcvBuffer.padding, "zenset")){
            ...
            if(strstr((char *)rcvBuffer.padding, "zenset")){
                struct in_addr p;
                unsigned char * ptr;
                char * tmp;
                ptr = (unsigned char *)&p;
                if(tmp = strtok((char *)rcvBuffer.padding, ","))
                {
                    if(tmp = strtok(NULL, ","))
                ...
                if(strcmp(zenith_device.ip, local_ip)
                    ...
                    modify_config_ini1(zenith_device.ip, zenith_device.netmask,zenith_device.gateway);
                    system("sync");
                    system("reboot");
                }else
